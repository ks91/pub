...
public class SimpleHttpBadRequestException extends IOException {

    public SimpleHttpBadRequestException() {
        super(SimpleHttpServer.S_400_BAD_REQUEST);
    }
...
// end of SimpleHttpBadRequestException.java
