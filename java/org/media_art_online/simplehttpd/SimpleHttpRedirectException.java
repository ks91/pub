...
public class SimpleHttpRedirectException extends IOException {

    public SimpleHttpRedirectException(String sURL) {
        super(SimpleHttpServer.S_302_FOUND);
        _sURL = sURL;
    }
...
// end of SimpleHttpRedirectException.java
