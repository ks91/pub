...
public class SimpleHttpNotModifiedException extends IOException {

    public SimpleHttpNotModifiedException() {
        super(SimpleHttpServer.S_304_NOT_MODIFIED);
    }
...
// end of SimpleHttpNotModifiedException.java
