...
public class SimpleHttpNotFoundException extends IOException {

    public SimpleHttpNotFoundException() {
        super(SimpleHttpServer.S_404_NOT_FOUND);
    }
...
// end of SimpleHttpNotFoundException.java
