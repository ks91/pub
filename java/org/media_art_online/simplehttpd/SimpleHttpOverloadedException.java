...
public class SimpleHttpOverloadedException extends IOException {

    public SimpleHttpOverloadedException() {
        super(SimpleHttpServer.S_503_SERVICE_UNAVAILABLE);
    }
...
// end of SimpleHttpOverloadedException.java
